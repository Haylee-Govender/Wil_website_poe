...
import { sixWeekCourses } from '../data/courses';
import { RootStackParamList } from '../types/navigation';
import Icon from 'react-native-vector-icons/FontAwesome';

/*
 * SixWeekCourses Screen References:
 * 
 ...
 * 
 * Image References Used in SixWeekCourses Screen:
 ...
 * (Used for: Cooking & Nutrition course image)
 * 
 ...
 * (Used for: Child Minding course image)
 * 
 ...
 * (Used for: Garden Maintenance course image)
 * 
 * Icons:
...
const SixWeekCoursesScreen: React.FC = () => {
  ...
  const activeRoute = 'SixWeekCourses';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.breadcrumb}>
        <View style={styles.breadcrumbContainer}>
          ...
          <Text style={styles.breadcrumbCurrent}>Six-Week Courses</Text>
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.introText}>
          Our focused six-week courses provide practical skills and knowledge to help you quickly enhance your capabilities. Perfect for those looking to upskill in a short time frame.
        </Text>
      ...
      {/* Why Choose Section - Moved above courses with gray background */}
        <View style={styles.whyChooseSection}>
          <View style={styles.whyChooseContent}>
            <Text style={styles.whyChooseTitle}>Why Choose Our Six-Week Courses?</Text>
            <Text style={styles.whyChooseText}>
              Our six-week courses are designed to provide focused, practical training that you can immediately apply in your personal and professional life. With experienced instructors and hands-on learning, you'll gain valuable skills in just six weeks.
            </Text>
            <Text style={styles.whyChooseText}>
              All courses include certification upon successful completion.
            </Text>
            <Pressable
